...
export const AREASFIJAS: AreaFija[] = [
    ...
    { id: 2, nombre: "Provisión de Servicios de Salud" },
    { id: 3, nombre: "Atención a Enfermedades Crónicas" },
    { id: 4, nombre: "Evaluación del Paciente" },
    { id: 5, nombre: "Gestión de Medicamentos" },
    { id: 6, nombre: "Gestión de Personal de Salud" }
];
